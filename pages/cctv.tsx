    ...
    <div>
      ...
      <section className="px-4 py-16 bg-[#222222] flex flex-col items-center text-white">
        <h1 className="text-2xl font-bold text-center">
          CCTV Installation and Maintainance
        </h1>
        ...
        <div className="lg:w-[85%] xl:w-[70%] lg:mr-auto lg:ml-auto lg:max-w-[80%]">
          ...
          <div className="flex flex-col space-y-4 justify-center items-center md:flex-row md:space-y-0 md:space-x-10 lg:space-x-20 ">
            <div className="md:w-[80%] ">
              <p className="mb-6 text-lg tracking-wider leading-7">
                For any area that needs monitoring, including houses,
                businesses, churches, warehouses, offshore installations,
                support vessels, and other places, we handle CCTV installation
                services.
              </p>
            </div>

            <div className="relative w-[350px] h-[230px] md:w-[600px] md:h-[290px] lg:w-[850px] lg:h-[400px]">
              <Image
                src="/images/cctv_system.webp"
                alt="CCTV system"
                fill
                quality={100}
      ...
      <section className="px-2 md:px-4 lg:px-10 py-10 bg-[#222222] text-white">
        <div className="lg:w-[95%] xl:w-[80%] flex flex-col lg:flex-row lg:space-x-10 items-center justify-center lg:mr-auto lg:ml-auto lg:max-w-[80%]">
          <div className="lg:hidden">
            <h2 className="text-xl lg:text-2xl">CUTTING EDGE TECHNOLOGY</h2>
            <div className="w-16 h-2 bg-[#800000] mt-1 mb-6"></div>
            <p className="mb-4 tracking-wider leading-7">
              When it comes to the bespoke design and installation of
              cutting-edge Closed Circuit Television systems (CCTV systems),
              Ping Telecoms is among the top Nigerian companies. Our skilled
              staff can provide professional design and installation of CCTV
              systems across the nation, whether you&apos;re searching for an
              analog or IP surveillance system for your building, schools,
              stores, factories, or homes. All sectors and governmental
              organizations can choose from a large selection of security camera
              systems and digital recorders offered by Ping Telecoms.
            </p>
          </div>

          <div className="relative w-[350px] h-[250px] md:w-[450px] md:h-[350px] xl:w-[550px] xl:h-[450px] mr-auto ml-auto">
            <Image
              src="/images/cctv_installation.webp"
