  ...
  return (
    <div>
      ...
      <section className="px-4 py-16 bg-[#222222] flex flex-col items-center text-white">
        <h1 className="text-2xl font-bold text-center">Runway Lighting</h1>
        <div className="w-16 h-2 bg-[#800000] mt-1 mb-6"></div>
        <h4 className="w-[90%] lg:w-[60%] text-center">
          At Ping Telecoms, we offer installation and maintenance of PAPI
          (Precision approach path indicator) runway lights which offer visual
          guidance to approaching aircraft with a configuration of
          high-intensity white lights running along the centreline of the runway
          and extending up to 600 meters(2,000 feet) beyond the threshold.
        </h4>
      </section>
          ...
          <div className="flex flex-col space-y-4 justify-center items-center md:flex-row md:space-y-0 md:space-x-10 lg:space-x-20 ">
            <div className="md:w-[80%] ">
              <p className="mb-6 text-lg tracking-wider leading-7">
                At airfields where aircraft operate in very poor visibility, we
                provide touchdown-zone lighting over the first 900 meters
                (3,000) feet from the runway threshold. These lights set in
                patterns flush with the runway pavement, provide guidance up to
                the final moment of touchdown.
              </p>
            </div>

            <div className="relative w-[350px] h-[230px] md:w-[600px] md:h-[290px] lg:w-[850px] lg:h-[400px]">
              <Image
                src="/images/runwaylights.webp"
                alt="Runway lights"
                fill
                quality={100}
