    ...
    <div>
      ...
      <section className="px-4 py-16 bg-[#222222] flex flex-col items-center text-white">
        ...
        <h4 className="w-[90%] lg:w-[60%] text-center">
          We train engineers and students in Open Source Operating Systems and
          Application software, Wireless Networking concepts and technologies,
          and VSAT installation principles and techniques.
        </h4>
      </section>
          ...
          <div className="flex flex-col space-y-4 justify-center items-center md:flex-row md:space-y-0 md:space-x-10 lg:space-x-20 ">
            <div className="md:w-[80%] ">
              <p className="mb-6 text-lg tracking-wider leading-7">
                At Ping Telecoms, the trainings we offer are specialized for
                those who are ready for field operations and are desirous to
                take certification examinations.
              </p>
            </div>

            <div className="relative w-[350px] h-[250px] md:w-[700px] md:h-[300px]">
              <Image
                src="/images/ping_telecoms_training.webp"
      ...
      <section className="px-2 md:px-4 lg:px-10 py-10 bg-[#222222] text-white">
        <div className="lg:w-[95%] xl:w-[80%] flex flex-col lg:flex-row lg:space-x-10 items-center justify-center lg:mr-auto lg:ml-auto lg:max-w-[80%]">
          <div className="lg:hidden">
            <h2 className="text-xl lg:text-2xl">CONSULTING</h2>
            <div className="w-16 h-2 bg-[#800000] mt-1 mb-6"></div>
