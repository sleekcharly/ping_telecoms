...
function ServicesItem({ image, altText, title, text }: Props) {
  return (
    <div className="w-[350px] p-4 bg-white hover:scale-105 hover:cursor-pointer rounded-md text-black transition-all duration-300">
